                                  ...
                                  @if($latitude && $longitude)
                                      <div class="mt-2">
                                          <small class="text-success">
                                              ...
                                              GPS tersimpan: {{ number_format((float)$latitude, 6) }}, {{ number_format((float)$longitude, 6) }}
                                          </small>
                                          <br>
  ...
  <script>
    function getCurrentLocationJS() {
        ...
        navigator.permissions.query({ name: 'geolocation' }).then(function(permissionStatus) {
            console.log('Status izin lokasi saat ini:', permissionStatus.state);
            ...
            if (permissionStatus.state === 'granted') {
                ...
                alert('Izin akses lokasi telah diblokir. Mohon aktifkan secara manual di pengaturan browser Anda (klik ikon gembok 🔒 di address bar).');
            }
            permissionStatus.onchange = function() {
                console.log('Status izin lokasi berubah menjadi:', this.state);
            };
        });
        ...
        function getLocation() {
            ...
            navigator.geolocation.getCurrentPosition(
                ...
                function(position) {
                    ...
                    @this.set('longitude', lon.toFixed(7));
                ...
                function(error) {
                    ...
                    let message = `Terjadi kesalahan tidak diketahui (Code: ${error.code}).`;
                    switch(error.code) {
